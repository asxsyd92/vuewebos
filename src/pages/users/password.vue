<template>
  <div>
    ...
    <form class="layui-form layui-form-pane" lay-filter="laypasswd" style="   width: 96%;">
      <div id="asxsyd92heater"></div>
          ...
          <div class="layui-col-md12">
            <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                <input class="layui-input" data-target="" id="oldpw" lay-filter="column" lay-verify="required"
                  name="oldpw" placeholder="请输入原密码" type="password">
              </div>
            </div>
          </div>
          <div class="layui-col-md12">
            <div class="layui-form-item">
              ...
              <div class="layui-input-block">
                <input class="layui-input" data-target="" id="newpw" lay-filter="column" lay-verify="pass" name="newpw"
