<template>
    <div>
      ...
      <lay-form-item label="值">
        <lay-input v-model="modle.value"></lay-input>
      </lay-form-item>
  
      <lay-form-item label="值">
        <lay-select v-model="modle.data">
          <lay-select-option selected="selected"  value="doc" label="doc"></lay-select-option>
          <lay-select-option  value="docx" label="docx"></lay-select-option>
          <lay-select-option  value="ppt" label="ppt"></lay-select-option>
          <lay-select-option  value="pptx" label="pptx"></lay-select-option>
          <lay-select-option  value="xls" label="xls"></lay-select-option>
          <lay-select-option  value="xlsx" label="xlsx"></lay-select-option>
        </lay-select>
      </lay-form-item>
      <lay-form-item label="类型">
        <lay-select v-model="modle.type">
          <lay-select-option selected="selected"  value="onlyoffice" label="text"></lay-select-option>
  ...
  interface IsetonlyofficeProps {
    data: any, setdata: Function
  }
  const props = withDefaults(defineProps<IsetonlyofficeProps>(), {
