        ...
        <!-- <a-layout-sider :trigger="null" collapsible v-model="collapsed">
            ...
            <a-menu theme="dark" mode="inline" :selectedKeys="[activeKey]">
                <template v-for="item in menus">
                    <a-sub-menu :key="item.tag" v-if="item.children">
                        <span slot="title"><a-icon type="mail" /><span>{{item.title || '--'}}</span></span>
                        <template  v-for="menu in item.children">
                            <a-menu-item :key="menu.tag" >
                                <a href="javascript:;" v-on:click="add_tab(menu)"  >
                                        <i v-bind:style="{color:Color(menu.color)}" :class="m.icon"></i>
                    ...
                    <template v-else>
                        <a-menu-item :key="item.id">
                               <a href="javascript:;" v-on:click="add_tab(menu)"  >
                                  <i v-bind:style="{color:Color(item.color)}" :class="item.icon"></i>
                                    <span>{{menu.title || '--'}}</span>
                                </a>
        ...
        methods:{
            add_tab(to){
                var m=this;
                  ...
                  m.$router.push({path: "/column/about"})
            },
            onEdit(e){
