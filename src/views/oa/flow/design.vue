<template>
  <div class="flow_region">
    <div class="nodes-wrap">
      <div v-for="item in nodeTypeList" :key="item.type" class="node" draggable="true" @dragstart="methods.drag(this, item)">
        <div class="log">
    ...
    <div id="flowWrap" ref="flowWrap" class="flow-wrap" @drop="methods.drop($event)" @dragover="methods.allowDrop($event)">
      <div id="flow">
        ...
        <flowNode v-for="item in data.nodeList" :id="item.id" :key="item.id" :node="item" @setNodeName="methods.setNodeName" @deleteNode = "methods.deleteNode" @changeLineState="methods.changeLineState"></flowNode>
      </div>
    </div>
  </div>
</template>
