        ...
        <lay-form ref="flowsetFormRef" :model="flowjson" >
            ...
            <lay-col :md="12">
                <lay-form-item label="分类:" prop="type">
                    <lay-tree-select v-model="type" :allow-clear="true" placeholder="请选择分类" :data="dicdata"
                    ></lay-tree-select>
...
interface IflowsetProps {
	flowjson:any, callback: Function
}
const props = withDefaults(defineProps<IflowsetProps>(), {
	flowjson:Object,  callback: Function
});
